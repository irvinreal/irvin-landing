...
const $$React = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${renderComponent($$result2, "Projects", $$Projects, { "client:load": true, "client:component-hydration": "load", "client:component-path": "D:/irvin/workspace/web/Front-end/vanilla/astro/irvin-landing/src/layouts/Projects.astro", "client:component-export": "default" }, { "default": ($$result3) => renderTemplate`${PAGES.react.map((page) => {
    return renderTemplate`${renderComponent($$result3, "Article", $$Article, { "url": page.url, "title": page.title })}`;
  })}` })}
` })}`;
}, "D:/irvin/workspace/web/Front-end/vanilla/astro/irvin-landing/src/pages/my-projects/react.astro", void 0);

const $$file = "D:/irvin/workspace/web/Front-end/vanilla/astro/irvin-landing/src/pages/my-projects/react.astro";
const $$url = "/irvin-landing/my-projects/react";
